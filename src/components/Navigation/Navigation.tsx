  ...
  return (
    <nav className="w-full bg-black text-white px-4 py-3 flex items-center justify-between shadow-md">
      ...
      <div className="md:hidden">
        <button aria-label="Open menu" className="focus:outline-none" onClick={() => setMenuOpen(!menuOpen)}>
      ...
      >
        ...
        <li>
          <Link href="/favorites" className="block px-2 py-2 hover:text-blue-400 transition-colors">
            Favorites
          </Link>
        </li>
      </ul>
